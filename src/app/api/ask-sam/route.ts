...
Baseline knowledge already in the system:
...
- Personal: Nigerian, Lagos, open to relocation, quad biking, mentoring, Nigerian tech community
...
- true  → question asks for specific project details, exact technical implementations, precise role descriptions, or anything that requires verbatim resume content
- false → answerable from the baseline knowledge listed above`;
...
- Enjoys quad biking, outdoor activities, and mentoring — has mentored PhD-level engineers
- Speaks at Nigerian tech events, deeply invested in the African tech ecosystem
- Operates with a DRI mindset: owns things end-to-end
